package com.yline.view.layout.label;
...
public class FlowLayout extends ViewGroup
{
	...
	public FlowLayout(Context context, AttributeSet attrs, int defStyle)
	{
		...
		TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ViewLayoutLabel);
		gravity = ta.getInt(R.styleable.ViewLayoutLabel_label_gravity, LabelGravity.LEFT.value);
		maxCountEachLine = ta.getInt(R.styleable.ViewLayoutLabel_label_max_count_each_line, -1);
		ta.recycle();
	}
