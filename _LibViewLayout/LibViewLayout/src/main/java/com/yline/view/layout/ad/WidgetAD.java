package com.yline.view.layout.ad;
...
import com.yline.view.layout.R;
...
public class WidgetAD
{
	...
	public View start(Context context, int count)
	{
		...
		LinearLayout linearLayout = (LinearLayout) parentView.findViewById(R.id.ll_widget_ad);
		initPoint(context, linearLayout);

		ViewPager viewPager = (ViewPager) parentView.findViewById(R.id.viewpager_widget_ad);
	...
	private void initViewPagerView(Context context, ViewPager viewPager)
	{
		...
		viewPager.setLayoutParams(new RelativeLayout.LayoutParams(getViewPagerWidth(), getViewPagerHeight()));
	...
	private void selectIndicatorPoint(LinearLayout parentLayout, int position)
	{
		...
		{
			LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) parentLayout.getChildAt(i).getLayoutParams();

			if (i == position)
			{
				layoutParams.width = getPointSizeAfter();
				layoutParams.height = getPointSizeAfter();
				parentLayout.getChildAt(i).setLayoutParams(layoutParams);
	...
	{
		return R.layout.lib_view_layout_ad;
	}
