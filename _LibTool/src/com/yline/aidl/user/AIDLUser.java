...
public class AIDLUser
{
    ...
    {
        Intent bindIntent = new Intent().setAction("com.yline.aidl.provider");
    ...
    public void testCall()
    {
        if (null != iService)
        {
            try
            {
                ...
                LogFileUtil.v(com.yline.aidl.User.TAG, "aidl user call success!!!");
            }
            catch (RemoteException e)
            {
                LogFileUtil.e(com.yline.aidl.User.TAG, "aidl user call failed");
                e.printStackTrace();
            }
        }
    }
