...
public class SuperSwipeRefreshLayout extends ViewGroup
{
	...
	public SuperSwipeRefreshLayout(Context context, AttributeSet attrs)
	{
		...
		screenWidth = LibViewUtil.getScreenWidth(context);
		headerViewHeight = LibViewUtil.dp2px(context, HEADER_VIEW_HEIGHT);
		footerViewHeight = LibViewUtil.dp2px(context, FOOTER_VIEW_HEIGHT);
		totalDragOffset = LibViewUtil.dp2px(context, DEFAULT_CIRCLE_TARGET);
