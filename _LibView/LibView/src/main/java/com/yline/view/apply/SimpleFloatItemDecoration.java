...
public class SimpleFloatItemDecoration extends LinearItemDecoration
{
	...
	{
		textPaint.setTextSize(SimpleUtil.dp2px(sContext, 18));
	...
	{
		int textLeft = bgRect.left + SimpleUtil.dp2px(sContext, 14);
	...
	{
		return SimpleUtil.dp2px(sContext, 42);
	}
